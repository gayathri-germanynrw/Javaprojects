...
public class EmployeeView {
	...
	public Employee employeeView() {
	    ...
	    System.out.println("Enter Lastt Name of employee\n "); 
	...
	public void displayEmployee(Employee employee) {
	    ...
	    System.out.println(employee.getFirstName()+employee.getLastName()+ "  is very very good boy and he is working here as a SCEINTIST");
	    }else {
